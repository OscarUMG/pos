        ...
        <div class="card-body">
                    ...
                    <form role="form" action="{{ route('ajustesdeinventario.addarticulo') }}" method="POST">
                        ...
                        <div class="form-goup row">
                            <div class="form-group col-4">
                                <label>Precio</label>
                                <input name="costo_total" readonly id="costo_total" min="1" step="0.01" required type="number"
                                    class="form-control">
                            </div>
                            <div class="form-group col-4">
                                <label>Salidas</label>
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <input name="costo_neto" id="costo_neto" min="1" step="0.01" class="form-control" required
                                    type="number" readonly hidden>
                            </div>
                            <div class="form-group col-4">
                                {{-- <label>I.V.A.</label> --}}
                                <input name="costo_imp" id="costo_imp" step="0.01" readonly required type="number"
            ...
            {{-- @if (session('ajuste'))
                <div class="col-md-6">
                    ...
                    <ol>
                        <li><Strong>Total salidas: </Strong>{{ $total_salidas }}</li>
                        <li><Strong>Total entradas: </Strong>{{ $total_entradas }}</li>
                        <li><Strong>Total costo neto: </Strong>Q{{ $total_costo_neto }}</li>
                        <li><Strong>Total costo impuesto: </Strong>Q{{ $total_costo_imp }}
                        </li>
                        <li><Strong>Total costo total: </Strong>Q{{ $total_costo_total }}
                        </li>
                    </ol>
                    ...
                    <tbody>
                        @foreach (session('ajuste') as $r)
                            <tr>
                                ...
                                @endif
                                <td>Q{{ $r->costo_neto + $r->costo_imp }}</td>
                                {{-- <td>Q{{ $r->costo_imp }}</td> --}}
                                @if ($r->entradas > 0)
                                    <td>Q{{ ($r->costo_neto + $r->costo_imp) * $r->entradas }}
                                    </td>
                                @endif
                                @if ($r->salidas > 0)
                                    <td>Q -{{ ($r->costo_neto + $r->costo_imp) * $r->salidas }}
                                    </td>
                                    </td>
                                @endif
                            </tr>
...
@section('js')
    ...
    <script>
        function updateCost() {
            ...
            document.getElementById("costo_imp").value = parseFloat(articulosAdd.find(a => a.id == id).costo_imp).toFixed(2);
            document.getElementById("costo_neto").value = parseFloat(articulosAdd.find(a => a.id == id).costo_neto).toFixed(2);
