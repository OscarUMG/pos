      ...
      <form role="form" action="{{route('articulos.store')}}" method="POST">
        ...
        <div class="form-group row">
          <div class="col-4">
            ...
            <input name="venta_neto" id="venta_neto"  class="form-control" required type="number" step="0.01" oninput="ActualizaValorVentaTotal()" hidden>
          </div>
          <div class="col-4">
            {{-- <label>I.V.A.</label> --}}
            <input name="venta_imp" id="venta_imp" required type="number" step="0.01" class="form-control" hidden>
          </div>
        </div>
