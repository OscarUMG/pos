    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                {{-- <div class="col-4">
                    <p><strong>Costo neto:</strong>Q {{ number_format($articulo->costo_neto, 0, '', '.') }}</p>
                    <p><strong>I.V.A.:</strong>Q {{ number_format($articulo->costo_imp, 0, '', '.') }}</p>
                    <p><strong>Costo total:</strong>Q
                        {{ number_format($articulo->costo_neto + $articulo->costo_imp, 0, '', '.') }}</p>
                    <p><strong>Costo total stock:</strong>Q
                        {{ number_format(($articulo->costo_neto + $articulo->costo_imp) * $articulo->stock, 0, '', '.') }}
                    </p>
                </div>
                <div class="col-4">
                    <p><strong>Venta neto:</strong>Q {{ number_format($articulo->venta_neto, 0, '', '.') }}</p>
                    <p><strong>I.V.A.:</strong>Q {{ number_format($articulo->venta_imp, 0, '', '.') }}</p>
                    <p><strong>Venta total:</strong>Q
                        {{ number_format($articulo->venta_neto + $articulo->venta_imp, 0, '', '.') }}</p>
                    <p><strong>Venta total stock:</strong>Q
